          ...
          <footer className="bg-dark-blue text-white py-8 mt-16">
            <div className="container mx-auto px-4">
              ...
              <div className="border-t border-gray-600 mt-8 pt-6 text-center text-gray-300">
                <p>&copy; 2025 by <a href="https://AcademyOSR.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-green-400">Academy of Self-Reliance</a>. All rights reserved.</p>
              </div>
            </div>
          </footer>
        </div>
